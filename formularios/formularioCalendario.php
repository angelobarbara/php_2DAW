<!DOCTYPE html>
 <html lang="es">
           ...
           if($i<$firstDayWeek || $i>=$last_cell){ // deja en blanco las celdas que no corresponden a días del mes
               echo "<td>&nbsp;</td>";
                   ...
                   if ($i%7==0 || isHoliday($day,$month)){
                       echo "<td style='background-color:red;border: 2px solid black;'>$day</td>";    // si corresponde con domingo, aparecen en rojo
                   }else{
                       echo "<td style='border: 2px solid black;'>$day</td>";
                   }
    ...
    <a href="verCodigo.php?src=formularioCalendario.php"> 
        <h3>Ver código</h3> 
      </a>
